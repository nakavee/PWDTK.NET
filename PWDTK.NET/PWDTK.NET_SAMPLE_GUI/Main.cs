...
namespace PWDTK_SAMPLE_GUI
{
    ...
    public partial class Main : Form
    {
        ...
        {
            if (PasswordMeetsPolicy(txtPassword.Text,PwdPolicy)) //A check to make sure the supplied password meets our defined password policy before using CPU resources to calculate hash, this step is optional
            {
                //Get a random salt
        ...
        {
            if (PasswordMeetsPolicy(txtPassword.Text, PwdPolicy)) //If password doesn't meet policy don't bother using CPU resource to calculate Hash
            {
